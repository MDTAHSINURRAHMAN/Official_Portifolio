...
const FindUpdate = () => {
    ...
    const { data: socialLinksData, refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get('http://localhost:3000/find-update');
            return res.data;
        }
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:3000/find-update', socialLink);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:3000/find-update/${id}`);
            refetch();
        } catch (error) {
            ...
            <div className="bg-base-200 p-6 rounded-lg mb-6">
                <div className="grid grid-cols-2 gap-4">
                    {socialLinksData?.map((link) => (
                        <div key={link._id} className="flex items-center justify-between space-x-2 bg-base-100 p-4 rounded-lg">
                            ...
                            <div className="border p-4 rounded-lg">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        />
                                        {socialLink.logo && <img src={socialLink.logo} alt="Logo Preview" className="mt-2 w-10 h-10 object-cover"/>}
                                    </div>
                                </div>
                            </div>
