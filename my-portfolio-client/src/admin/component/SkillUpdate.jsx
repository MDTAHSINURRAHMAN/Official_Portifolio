...
const SkillUpdate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:3000/skills', skill);
            ...
            <div className="bg-base-200 p-6 rounded-lg mb-6">
                <div className="grid grid-cols-2 gap-4">
                    {skillsData?.map((skill) => (
                        <div key={skill._id} className="flex items-center justify-between space-x-2 bg-base-100 p-4 rounded-lg">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="url"
                                            value={skill.iconUrl}
                                            onChange={(e) => handleSkillChange('iconUrl', e.target.value)}
                                            className="input input-bordered w-full"
