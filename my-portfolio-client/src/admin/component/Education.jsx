  ...
  const { data: educationData, refetch } = useQuery({
    ...
    queryFn: async () => {
      const res = await axios.get(
        "https://official-portfolio-nine.vercel.app/education"
      );
      return res.data;
    },
  });
          ...
          <div className="bg-base-200 p-6 rounded-lg mb-6">
            <div className="grid grid-cols-1 gap-4">
              {educationData[0].education?.map((edu, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-4 bg-base-100 p-4 rounded-lg"
                >
                  <img
                    src={edu.logo}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={edu.logo}
                        onChange={(e) =>
                          handleEducationChange(index, "logo", e.target.value)
                        }
