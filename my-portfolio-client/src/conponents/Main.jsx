...
const Main = () => {
  const {
    ...
    queryFn: async () => {
      const response = await axios.get(
        "https://official-portfolio-nine.vercel.app/intro"
      );
  ...
  const { data: socialLinks } = useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get(
        "https://official-portfolio-nine.vercel.app/find"
      );
      return response.data;
    },
    staleTime: 1000 * 60 * 5,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          ...
          >
            <div className="text-center">
              ...
              />
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-text-color mb-2">
                {displayName}
              </h1>
              <p className="text-base sm:text-lg text-text-color/80 mb-2">
                {intro[0]?.designation}
              </p>
