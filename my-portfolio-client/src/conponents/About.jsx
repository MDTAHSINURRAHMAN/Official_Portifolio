            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-text-color/80 leading-relaxed">{about[0]?.journey}</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-text-color/80 leading-relaxed">{about[0]?.personality}</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-text-color/80 leading-relaxed">{about[0]?.workInterests}</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-text-color/80 leading-relaxed">{about[0]?.hobbies}</p>
                    </motion.div>
                </div>
            </motion.section>
        </div>
